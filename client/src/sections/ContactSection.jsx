                            ...
                            <div key={item.label} className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    {item.href ? (
                                        ...
                                        className="text-sm font-medium text-zinc-700 dark:text-zinc-300 hover:text-violet-500 transition-colors"
                                        >
                                    {item.value}
                                        </a>
                                        ) : (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                className="w-full bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-lg px-4 py-2.5 text-sm text-zinc-900 dark:text-zinc-100 placeholder:text-zinc-400 focus:outline-none focus:border-violet-500 transition-colors resize-none"
                            />
                        </div>
                        <button
                            type="submit"
