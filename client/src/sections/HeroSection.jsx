            ...
            <div className="max-w-6xl mx-auto w-full grid md:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <h1 className="text-4xl md:text-6xl font-extrabold text-zinc-900 dark:text-white leading-tight mb-4">
                        Bonjour, je suis{' '}
                        <span className="bg-gradient-to-r from-violet-500 to-purple-600 bg-clip-text text-transparent">Aboubacar</span>
                    </h1>
                    <p className="text-lg text-zinc-600 dark:text-zinc-400 mb-2 font-medium">{PERSONAL_INFO.title}</p>
                    <p className="text-sm text-zinc-500 dark:text-zinc-500 mb-8">{PERSONAL_INFO.subtitle}</p>
                    <div className="flex flex-wrap gap-3">
                        <a href="#contact" className="bg-violet-600 hover:bg-violet-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors">Me contacter</a>
                        <a href="#projects" className="bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 text-zinc-900 dark:text-white font-semibold px-6 py-3 rounded-lg transition-colors">Voir mes projets</a>
                        <a href={PERSONAL_INFO.github} target="_blank" rel="noopener noreferrer" className="border border-zinc-200 dark:border-zinc-700 hover:border-violet-500 text-zinc-600 dark:text-zinc-400 font-semibold px-6 py-3 rounded-lg transition-colors">GitHub ↗</a>
                    </div>
