            ...
            <div className="max-w-6xl mx-auto">
              ...
              construit
                ...
                <div className="text-center mt-10">
                    ...
                    className="inline-flex items-center gap-2 border border-zinc-200 dark:border-zinc-700 hover:border-violet-500 text-zinc-600 dark:text-zinc-400 hover:text-violet-500 font-semibold px-6 py-3 rounded-lg transition-colors"
                    >
